...
<body class="page-index">
    ...
    <div class="container">
        <!-- banner图片 -->
        <div class="banner" style="background-image: url(../../../images/category/LED-headlight-bulb-banner.jpg);">
            <h1 class="title-box">
                <span class="title">led headlight bulb</span>
            </h1>
            <h2>Direct Replacement Compatible With All Auto</h2>
        </div>
        <div class="content">
            <div class="main">
                <ul class="list">
                   <li class="item">
                        ...
                        <a class="desc" href="./ecl-e9k/">
                            <span class="current">LED Truck Headlight ECL-E9K</span>
                            <span class="more">View More</span>
                        </a>
                   </li> 
                   <li class="item">
                        <a class="thumb" href="./ecl-e13/">
                            <img src="../../../images/category/main-image-ECL-E13.jpg" alt="main-image-ECL-E13" />
                        </a>
                        <a class="desc" href="./ecl-e13/">
                            <span class="current">LED Car Headlight ECL-E13</span>
                            <span class="more">View More</span>
                        </a>
                   </li>
                   <li class="item">
                        <a class="thumb" href="./ecl-d9/">
                            <img src="../../../images/category/main-image-ECL-D9.jpg" alt="main-image-ECL-D9" />
                        </a>
                        <a class="desc" href="./ecl-d9/">
                            <span class="current">LED Car Headlight ECL-D9</span>
                            <span class="more">View More</span>
                        </a>
                    </li>
                    <li class="item">
                        <a class="thumb" href="./ecl-10c/">
                            <img src="../../../images/category/main-image-ECL-10C.jpg" alt="main-image-ECL-10C" />
                        </a>
                        <a class="desc" href="./ecl-10c/">
                            <span class="current">LED Car Headlight ECL-10C</span>
                            <span class="more">View More</span>
                        </a>
                    </li> 
                    <li class="item">
                        <a class="thumb" href="./ecl-k7/">
                            <img src="../../../images/category/main-image-ECL-K7.jpg" alt="main-image-ECL-K7" />
                        </a>
