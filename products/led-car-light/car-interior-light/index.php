...
<body class="page-index">
    ...
    <div class="container">
        <!-- banner图片 -->
        <div class="banner" style="background-image: url(../../../images/category/car-interior-light-banner.jpg);">
            <h1 class="title-box">
                <span class="title">car interior light</span>
            </h1>
            <h2>Create Visual Enjoyment Space For Your Car</h2>
        </div>
        <div class="content">
            <div class="main">
                <ul class="list" style="justify-content: center;">
                   <li class="item">
                        ...
                        <a class="desc" href="./ecl-de48c/">
                            <span class="current">Car Interior Light ECL-DE48C</span>
                            <span class="more">View More</span>
                        </a>
                   </li> 
                   <li class="item">
                        <a class="thumb" href="./ecl-de48u/">
                            <img src="../../../images/category/main-image-ECL-EV48U.jpg" alt="main-image-ECL-DE48U" />
                        </a>
                        <a class="desc" href="./ecl-de48u/">
                            <span class="current">Car Interior Light ECL-DE48U</span>
                            <span class="more">View More</span>
                        </a>
                   </li>
                </ul>
            ...
            <div class="blog">
                ...
                <div class="blog-content">
                    <h2>Practical guideline for EchoLumen Car Interior Light</h2>
                    <p>The most original cars we got from 4S store/dealer are designed to meet the very basic driving needs, all the lights interior and exterior are all serving that core purpose. It sounds bit dull for car lovers, but we can always find a perfect solution to make amend by installing car interior light or atmosphere light for car. 
                        If you are bored with the dark space in your car especially when driving at night, it is time to get some new stuff to light it up. By using car interior light or atmosphere light for car, you can enjoy an upgraded driving experience. </p>
                    <div class="square">
